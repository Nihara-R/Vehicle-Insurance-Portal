...
<body>
    ...
    <div id="user">
        ...
        <a href="delet.php"><button type="button" name="button">DELET</button></a>
...
<a href="delete_contact.php"><button type="button" name="button">DELET</button></a>
...
<a href="delete_payment.php"><button type="button" name="button">DELET</button></a>
...
<a href="delete_claim.php"><button type="button" name="button">DELET</button></a>
